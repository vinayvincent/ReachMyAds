...
const sectionsMeta = [
  { id: 'about',                number: '01', title: 'About ReachMyAds' },
  { id: 'eligibility',          number: '02', title: 'Eligibility' },
  { id: 'user-accounts',        number: '03', title: 'User Accounts' },
  { id: 'services',             number: '04', title: 'Services Provided' },
  { id: 'acceptable-use',       number: '05', title: 'Acceptable Use' },
  { id: 'platform-policies',    number: '06', title: 'Advertising Platform Policies' },
  { id: 'ai-content',           number: '07', title: 'AI-Generated Content' },
  { id: 'payments',             number: '08', title: 'Payments & Subscription' },
  { id: 'intellectual-property',number: '09', title: 'Intellectual Property' },
  { id: 'data-privacy',         number: '10', title: 'Data & Privacy' },
  { id: 'service-availability', number: '11', title: 'Service Availability' },
  { id: 'liability',            number: '12', title: 'Limitation of Liability' },
  { id: 'termination',          number: '13', title: 'Account Suspension & Termination' },
  ...
  { id: 'contact-info',         number: '17', title: 'Contact Information' },
];
    ...
    <main className="min-h-screen">
      ...
      <div className="mx-auto max-w-[1200px] px-6 py-16">
        <div className="flex gap-10 items-start">
          ...
          <TermsTOC sections={sectionsMeta} />
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            <section id="eligibility" aria-labelledby="heading-eligibility"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">To use ReachMyAds, you must:</p>
                <div className="space-y-2">
                  {['Be legally allowed to enter into agreements', 'Provide accurate registration information', 'Use the platform only for lawful business purposes'].map((item) => (
            ...
            <section id="user-accounts" aria-labelledby="heading-user-accounts"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">Users are responsible for:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {['Maintaining account security', 'Protecting login credentials', 'Keeping account information updated', 'Managing authorized team members'].map((item) => (
                    <div key={item} className="flex items-center gap-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/50 px-3.5 py-2.5 text-[13px] text-slate-700 dark:text-slate-300">
            ...
            <section id="services" aria-labelledby="heading-services"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">ReachMyAds may provide:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {['Campaign management tools', 'AI-generated ad suggestions', 'Analytics and reporting', 'Multi-platform ad deployment', 'Bid optimization tools', 'Wallet & payment management', 'Team collaboration features'].map((item) => (
                    <div key={item} className="flex items-center gap-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/50 px-3.5 py-2.5 text-[13px] text-slate-700 dark:text-slate-300">
            ...
            <section id="acceptable-use" aria-labelledby="heading-acceptable-use"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">Users must <strong className="text-red-600 dark:text-red-400">not</strong>:</p>
                <div className="space-y-2">
                  {['Use the platform for illegal activities', 'Upload harmful, offensive, misleading, or copyrighted content without permission', 'Attempt to hack, disrupt, or misuse the platform', 'Use fake identities or misleading business information', 'Violate advertising platform policies', 'Send spam or unauthorized promotions'].map((item) => (
            ...
            <section id="ai-content" aria-labelledby="heading-ai-content"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">ReachMyAds may provide AI-generated:</p>
            ...
            <section id="intellectual-property" aria-labelledby="heading-intellectual-property"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-3">
                {[
            ...
            <section id="service-availability" aria-labelledby="heading-service-availability"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">We aim to keep the platform available and reliable, but we do not guarantee uninterrupted service.</p>
                <p className="text-[14px]">ReachMyAds may:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <section id="liability" aria-labelledby="heading-liability"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[14px] font-semibold text-slate-700 dark:text-slate-300">ReachMyAds is not responsible for:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {['Advertising performance losses', 'Revenue loss', 'Business interruption', 'Campaign rejection by third-party platforms', 'Data loss caused by external systems', 'Indirect or consequential damages'].map((item) => (
                    <div key={item} className="flex items-center gap-2.5 rounded-lg bg-red-50/60 dark:bg-red-950/20 border border-red-500/10 px-3.5 py-2.5 text-[13px] text-slate-700 dark:text-slate-300">
            ...
            <section id="termination" aria-labelledby="heading-termination"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[14px]">ReachMyAds may suspend or terminate accounts if users:</p>
                <div className="space-y-2">
            ...
            <section id="third-party" aria-labelledby="heading-third-party"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">ReachMyAds integrates with third-party services and advertising platforms.</p>
                <p className="text-[14px]">We are not responsible for:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <section id="contact-info" aria-labelledby="heading-contact-info"
              ...
              <div className="text-[14px] leading-relaxed text-slate-600 dark:text-slate-400 space-y-4">
                <p className="text-[15px]">For questions regarding these Terms, contact:</p>
