              ...
              <div className="grid grid-cols-1 gap-12">
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-8">
                  <a
                    ...
                    className="group flex items-center gap-3 text-[14px] font-medium text-slate-600 transition-all hover:text-slate-900"
                  >
                    <span className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 ring-1 ring-slate-200 transition-all group-hover:bg-accent-50 group-hover:ring-accent-200">
                  ...
                  <div className="flex flex-col items-center gap-4 sm:flex-row sm:gap-6">
                    <div className="flex items-center gap-3 text-[14px] font-medium text-slate-600">
                      <span className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 ring-1 ring-slate-200 transition-all hover:bg-accent-50 hover:ring-accent-200">
                        <svg className="h-5 w-5 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                      </span>
                      <a href="tel:+916238299803" className="transition-all hover:text-slate-900">+91 62382 99803</a>
                    </div>
                    <div className="hidden h-4 w-px bg-slate-200 sm:block" />
                    <div className="flex items-center gap-3 text-[14px] font-medium text-slate-600">
                      <span className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 ring-1 ring-slate-200 transition-all hover:bg-accent-50 hover:ring-accent-200">
                      ...
                      <a href="tel:+917012112355" className="transition-all hover:text-slate-900">+91 70121 12355</a>
                    </div>
                  </div>
                </div>
              </div>
