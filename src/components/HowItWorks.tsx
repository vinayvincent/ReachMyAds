  ...
  return (
    ...
    >
      ...
      {index < steps.length - 1 && (
        <div className="hidden lg:block absolute top-[28px] left-[calc(100%+32px)] w-[calc(100%-64px)] h-px bg-gradient-to-r from-slate-300 dark:from-accent-500/20 via-slate-200 dark:via-accent-500/10 to-transparent" />
      )}
    </motion.div>
  );
}
    ...
    <section className="relative py-24 sm:py-32 bg-transparent border-y border-slate-200/50 dark:border-slate-800/50">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
          ...
          <div className="hidden md:block h-px flex-1 bg-gradient-to-r from-slate-200 dark:from-white/10 to-transparent mb-6 mx-8" />
        </div>
